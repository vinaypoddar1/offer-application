...
public class OfferRepository {
	...
	private void addInitialData() {
		...
		map.put("molly@msn.com", new Application("Java-Backend", "molly@msn.com", "Sample Resume Text", Status.APPLIED));
		map.put("andrea@gmail.com", new Application("Java-Backend", "andrea@gmail.com", "Sample Resume Text", Status.APPLIED));
		map.put("john@yahoo.com", new Application("Java-Backend", "john@yahoo.com", "Sample Resume Text", Status.HIRED));
		...
		map1.put("andrea@gmail.com", new Application("Frontend", "andrea@gmail.com", "Sample Resume Text", Status.APPLIED));
		map1.put("michele@yahoo.com", new Application("Frontend", "michele@yahoo.com", "Sample Resume Text", Status.HIRED));
